...
const ITEMS = (athleteId: string) => [
  ...
  { href: `/me/${athleteId}#progress`, label: 'Progress', d: 'M22 12h-4l-3 9L9 3l-3 9H2' },
  // Health — heart
  { href: `/me/${athleteId}#recovery`, label: 'Body', d: 'M12 21s-7.5-4.9-10-9.4C.6 8.9 1.9 5.5 5 5.5c1.9 0 3.2 1.1 4 2.3.8-1.2 2.1-2.3 4-2.3 3.1 0 4.4 3.4 3 6.1-2.5 4.5-10 9.4-10 9.4z' },
  // Chat — speech bubble
